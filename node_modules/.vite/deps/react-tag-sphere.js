...
// node_modules/react-tag-sphere/lib/esm/index.js
...
var updateItemPosition = function(item, sc, depth, userSelect, blur, blurMultiplier, grayscale) {
  ...
  itemEl.style.zIndex = Math.floor(alpha * 1e3) + "";
...
var createItem = function(text, index, textsLength, size, itemRef) {
  ...
  var itemEl = import_react.default.createElement("span", { ref: itemRef, key: index, style: itemStyles }, text);
...
var defaultState = {
  tags: [
    ...
    "you",
    "like",
    import_react.default.createElement("img", { width: 50, src: "https://cdn.svgporn.com/logos/react.svg", alt: "Random image" }),
    "it?",
    "Glad",
    "to",
    "see",
...
var TagSphere = function(props) {
  ...
  var depth = 2 * radius;
  var size = 1.5 * radius;
  var itemHooks = tags.map(function() {
    return (0, import_react2.createRef)();
  });
  var _b = (0, import_react2.useState)([]), items = _b[0], setItems = _b[1];
  ...
  var _c = (0, import_react2.useState)(true), firstRender = _c[0], setFirstRender = _c[1];
  var _d = (0, import_react2.useState)(maxSpeed), lessSpeed = _d[0], setLessSpeed = _d[1];
  var _e = (0, import_react2.useState)(false), active = _e[0], setActive = _e[1];
  var _f = (0, import_react2.useState)(0), mouseX = _f[0], setMouseX = _f[1];
  var _g = (0, import_react2.useState)(0), mouseY = _g[0], setMouseY = _g[1];
  var handleMouseMove = function(e) {
    var rect = containerRef.current.getBoundingClientRect();
    setMouseX(function() {
      return (e.clientX - (rect.left + rect.width / 2)) / 5;
    });
    setMouseY(function() {
      return (e.clientY - (rect.top + rect.height / 2)) / 5;
    });
  };
  ...
  (0, import_react2.useEffect)(function() {
    init();
    setItems(function(items2) {
      return __spreadArray([], items2, true);
    });
  }, []);
  (0, import_react2.useEffect)(function() {
  ...
  return import_react.default.createElement("div", { className: props.className, ref: containerRef, onMouseOver: function() {
    setActive(function() {
      return true;
    });
    setFirstRender(function() {
      return false;
    });
  ...
  }, style: __assign(__assign({}, defaultStyles.getContainer(radius, fullWidth, fullHeight)), style) }, items.map(function(item) {
    return item.el;
  }));
};
export {
...
//# sourceMappingURL=react-tag-sphere.js.map
